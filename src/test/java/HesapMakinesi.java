...
public class HesapMakinesi {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        System.out.println("Sonuç Alanı Bulundu.");
        String sonuc1text = sonuc1.getText(); //elementi aldım 1 sayısını buldum.
        System.out.println("Beklenen Sonuç: 200, Gerçekleşen Sonuç: " + sonuc1text);
        try {
            Assert.assertEquals(sonuc1text, "= 200","Sonuç hatalıdır");
        }
        catch (Exception e)
        {
            throw e;
